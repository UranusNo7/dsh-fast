...
export type PhysicalAdapterForTier = (serviceTier: PiAiServiceTier | undefined) => PiAiAdapter
...
function retryableFailure(failure: LlmFailure, serviceTier: PiAiServiceTier | undefined): boolean {
...
function retryableError(error: unknown, serviceTier: PiAiServiceTier | undefined): boolean {
