...
export interface ModelSelectInjected {
  ...
  /**
   * Set the session-local Fast mode.
   * @param active - whether Fast should be active.
   * @returns whether the host accepted the mode change.
   */
  toggleFast: (active: boolean) => Promise<boolean>
}
