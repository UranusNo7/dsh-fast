...
2. Map the result:
   ...
   - `image` content blocks → discard with a `ctx.logger.warn` (the harness has no image content block type; [drop-image Agent Note](../../archived/simplification/2026-07-04-drop-image-content-block.md)).
