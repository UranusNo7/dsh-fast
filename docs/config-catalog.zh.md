...
依赖：[`PiAiModality`](../packages/llm/llm-pi-ai/src/index.ts) · [`PiAiProviderProfile`](../packages/llm/llm-pi-ai/src/index.ts) · [`PiAiServiceTier`](../packages/llm/llm-pi-ai/src/index.ts)

来源：[`packages/llm/codex-model-policy/src/config.ts:17`](../packages/llm/codex-model-policy/src/config.ts)
...
<a id="deepseek-aidsh-web-fetch-firecrawl"></a>
...
来源：[`packages/web/web-fetch-firecrawl/src/index.ts:38`](../packages/web/web-fetch-firecrawl/src/index.ts)
