  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'packages/llm/codex-model-policy/src/client/ModelSelect.tsx',
        'packages/llm/codex-model-policy/src/client/directory.ts',
        'packages/llm/codex-model-policy/src/client/index.ts',
        'packages/llm/codex-model-policy/src/client/service.ts',
